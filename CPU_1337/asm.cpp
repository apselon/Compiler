...
#include <cstring>
#include <ctime>
#include "my_libs/my_map.h"
using std::cout;
using std::endl;

#include "my_libs/good_functions.h"
#include "my_libs/super_define.h"
#include "my_libs/instructions.h"
#include "my_libs/dump.h"
#include "my_libs/my_file_lib.h"
